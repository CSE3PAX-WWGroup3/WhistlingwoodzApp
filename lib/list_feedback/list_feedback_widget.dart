...
class ListFeedbackWidget extends StatefulWidget {
  ...
  @override
  State<ListFeedbackWidget> createState() => _ListFeedbackWidgetState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<FeedbackRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<FeedbackRecord> listFeedbackFeedbackRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final listFeedbackFeedbackRecord =
            listFeedbackFeedbackRecordList.isNotEmpty
                ? listFeedbackFeedbackRecordList.first
                : null;
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  valueOrDefault<String>(
                                    listFeedbackFeedbackRecord?.positive
                                        .toString(),
                                    '0',
                                  ),
                                  style: FlutterFlowTheme.of(context)
                              ...
                              Text(
                                valueOrDefault<String>(
                                  listFeedbackFeedbackRecord?.negative
                                      .toString(),
                                  '0',
                                ),
                                style: FlutterFlowTheme.of(context)
                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<List<UserFeedbackRecord>>(
                        stream: queryUserFeedbackRecord(
                          queryBuilder: (userFeedbackRecord) =>
                              userFeedbackRecord.orderBy('timestamp',
                                  descending: true),
                        ),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          ...
                          List<UserFeedbackRecord>
                              listViewUserFeedbackRecordList = snapshot.data!;
