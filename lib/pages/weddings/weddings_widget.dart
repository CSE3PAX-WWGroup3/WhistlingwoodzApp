...
import 'weddings_model.dart';
export 'weddings_model.dart';

class WeddingsWidget extends StatefulWidget {
...
class _WeddingsWidgetState extends State<WeddingsWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WeddingsModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'weddings'});
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        flex: 3,
                                        child: StreamBuilder<
                                            List<WeddingThemeRecord>>(
                                          stream: queryWeddingThemeRecord(),
                                          builder: (context, snapshot) {
                                            ...
                                            List<WeddingThemeRecord>
                                                themePickWeddingThemeRecordList =
                                                snapshot.data!;
                                            return FlutterFlowDropDown<String>(
                                              ...
                                              onChanged: (val) async {
                                                setState(() => _model
                                                    .themePickValue = val);
                                                logFirebaseEvent(
                                                    'WEDDINGS_themePick_ON_FORM_WIDGET_SELECT');
                                                logFirebaseEvent(
                                                    'themePick_update_app_state');
                                                setState(() {
                                                  FFAppState().corporateTheme =
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        flex: 3,
                                        child: StreamBuilder<
                                            List<WeddingFunctionRecord>>(
                                          stream: queryWeddingFunctionRecord(),
                                          builder: (context, snapshot) {
                                            // Customize what your widget looks like when it's loading.
                                            if (!snapshot.hasData) {
                                              return Center(
                                              ...
                                              return FlutterFlowDropDown<
                                                ...
                                                onChanged: (val) async {
                                                  setState(() => _model
                                                      .venuePickValue = val);
                                                  logFirebaseEvent(
                                                      'WEDDINGS_venuePick_ON_FORM_WIDGET_SELECT');
                                                  logFirebaseEvent(
                                                      'venuePick_update_app_state');
                                                  setState(() {
                                                    FFAppState()
                                                        .corporateVenue = _model
                                                                .venuePickValue ==
                                                            'Other'
                                                        ? _model
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: TextFormField(
                                          ...
                                          focusNode:
                                              _model.numberGuestsFocusNode,
                                          onFieldSubmitted: (_) async {
                                            logFirebaseEvent(
                                                'WEDDINGS_numberGuests_ON_TEXTFIELD_SUBMI');
                                            logFirebaseEvent(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return FlutterFlowDropDown<String>(
                                              ...
                                              onChanged: (val) async {
                                                ...
                                                logFirebaseEvent(
                                                    'WEDDINGS_budget_ON_FORM_WIDGET_SELECTED');
                                                logFirebaseEvent(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'WEDDINGS_PAGE_CANCEL_BTN_ON_TAP');
                                            logFirebaseEvent(
                                                'Button_navigate_to');
