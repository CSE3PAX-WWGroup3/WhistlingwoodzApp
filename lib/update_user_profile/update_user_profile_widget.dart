...
class _UpdateUserProfileWidgetState extends State<UpdateUserProfileWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      stream: UsersRecord.getDocument(widget.userInformation!),
      builder: (context, snapshot) {
        ...
        final updateUserProfileUsersRecord = snapshot.data!;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('UPDATE_USER_PROFILE_arrow_back_ICN_ON_TA');
                  ...
                  SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          updateUserProfileUsersRecord.email,
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    fontFamily: 'Readex Pro',
                                    color: Colors.white,
                              ...
                              Expanded(
                                ...
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      8.0, 0.0, 8.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.displaNameController ??=
                                        TextEditingController(
                                      text: updateUserProfileUsersRecord
                                          .displayName,
                                    ),
                                  ...
                                  child: TextFormField(
                                    controller: _model.firstNameController ??=
                                      ...
                                      text: valueOrDefault<String>(
                                        updateUserProfileUsersRecord.firstname,
                                        'n/a',
                                      ),
                                    ),
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model.surnameController ??=
                                        TextEditingController(
                                      text: valueOrDefault<String>(
                                        updateUserProfileUsersRecord.surname,
                                        'n/a',
                                      ),
                                    ),
                        ...
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              logFirebaseEvent('saveChanges_alert_dialog');
                              await showDialog(
                                context: context,
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'UPDATE_USER_PROFILE_LOG_OUT_BTN_ON_TAP');
